...
const clientId = "BOqNa2qc6B1wJN7_uIGkf1s3MfEEoSgQOMyKHnBJY4b9-Vz-rIOb9rxxNXEtgbUO47WCXlppq2bt5v0HzKyIHjo"; // get from https://dashboard.web3auth.io
        ...
        adapterSettings: {
          ...
          loginConfig: {
            ...
            google: {
              ...
              verifier: "web3auth_test", // Please create a verifier on the developer dashboard and pass the name here
